...
var params,columns,space,data,screenWidth,newWidth,columnWidth,frameBGcolor,itemsOptions,onItemClick, frames, items; 
...
var removeAt = function(pos){
	var frame = frames[pos];
	$.fgScrollView.remove(frame);
	frames.splice(pos, 1);
	items.splice(pos, 1);
};
